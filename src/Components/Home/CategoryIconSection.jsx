...
//       }}
//       onMouseEnter={(e) => {
//         e.currentTarget.style.boxShadow = CATEGORY_THEME.colors.hoverShadow;
//       }}
//       onMouseLeave={(e) => {
...
//       const result = await response.json();
//       const categoryList = normalizeCategoryList(result);
...
//               {categories.map((item) => {
//                 const Icon = getCategoryIcon(item);
//                 const categoryParam = item?.slug || item?._id;
