...
import { Pencil, Trash2, CheckCircle, SquareCheckBig } from 'lucide-react';
...
const AddressSection = () => {
  ...
  const handleSetDefault = (id) => {
    ...
    dispatch(updateAddress({ id: id, data: defaultStatus }));
    setTimeout(() => {
      dispatch(getAllAddresses());
    }, 500);
  };
            ...
            addresses.map((addr, idx) => (
              <div key={idx} className="border-b pb-3 relative group">
                <div className="space-y-1">
                  ...
                  <p>
                    <span className="font-medium">Division:</span> {addr.division}
                  </p>
                  <p>
                ...
                <div className="mt-2">
                  {addr.isDefault ? (
                    ...
                    <button
                      ...
                      className="text-red-500 text-xs flex items-center gap-1 hover:text-blue-600 hover:underline"
                    >
                      <SquareCheckBig size={14} /> Set as Default
                    </button>
                  )}
                </div>
              </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm z-50 flex justify-center items-center">
          <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-6 relative">
            ...
            <div className="space-y-3">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-600 capitalize mb-1"></label>
                <input
                  name="fullName"
